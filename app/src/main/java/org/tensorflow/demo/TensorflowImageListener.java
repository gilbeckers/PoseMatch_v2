...
class TensorFlowImageListener implements OnImageAvailableListener {
    ...
    // When takePicture() is called, image is saved in other dir than .tensorflow
    //private boolean savePreviewPose = false;
    ...
    public void onImageAvailable(final ImageReader reader) {
        ...
        if (SAVE_PREVIEW_BITMAP) {
            LOGGER.e("Saving image to TENSORFRLOW");
    ...
    public void takePic() {
        readyForNextImage = true;
        LOGGER.e("in takePic() in-appppp Taking picture");
        return;
    }
